...
/**
 * archive module
 * Table definition for 'items/media'
 *
...
$zz['title'] = 'Media for Items';
$zz['table'] = '/*_PREFIX_*/items_media';

$zz['fields'][1]['title'] = 'ID';
$zz['fields'][1]['field_name'] = 'item_medium_id';
$zz['fields'][1]['type'] = 'id';

$zz['fields'][2]['field_name'] = 'item_id';
$zz['fields'][2]['type'] = 'select';
$zz['fields'][2]['sql'] = 'SELECT item_id, code, item
	FROM /*_PREFIX_*/items
	ORDER BY identifier';
...
$zz['subselect']['sql'] = 'SELECT item_id, filename, version
		, t_mime.extension AS thumb_extension
		, o_mime.extension
	FROM /*_PREFIX_*/items_media
	...
	AND /*_PREFIX_*/items_media.sequence = 1
';
$zz['subselect']['image'] = $zz['fields'][5]['path'];

$zz['sql'] = 'SELECT /*_PREFIX_*/items_media.*
	, /*_PREFIX_*/items.item
	, CONCAT("[", /*_PREFIX_*/media.medium_id, "] ", /*_PREFIX_*/media.title) AS image
	...
	LEFT JOIN /*_PREFIX_*/filetypes AS t_mime 
		ON /*_PREFIX_*/media.thumb_filetype_id = t_mime.filetype_id
';
$zz['sqlorder'] = ' ORDER BY /*_PREFIX_*/items.title DESC, sequence';
